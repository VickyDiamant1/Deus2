...
A virtual environment ensures that project dependencies are isolated from the system's Python installation and from other projects. This makes managing dependencies easier and avoids version conflicts.
...
The server should now be running at `http://localhost:8000`. (please go to http://localhost:8000/admin)

## API Testing for Windows (for linux please scroll)
